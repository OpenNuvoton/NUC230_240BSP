...
#define VBG_VOLTAGE (1250) /* 1.25V = 1250 mV (Typical band-gap voltage of NUC230_240 series) */
...
int32_t main(void)
{
    ...
    /*------------------------------------------------------------------------------------------------------------------
       ...
       Note 1 : The measured AVDD has deviation that causes by the band-gap voltage has deviation in different temperature, power voltage and ADC conversion deviation.(4 LSB)
                ...
                The Spec. of band-gap voltage in NUC230_240 series is as follows:
                -----------------------------------------------------------------------------------------
                |                  | Min.   | Typ.   | Max.   |                                         |
                |                  |--------------------------- VDD = 2.5 V ~ 5.5 V                     |
       ...
       Note 2: In this sample code is using the typical value of NUC230_240 series: 1.25 V, and it can be modified by VBG_VOLTAGE definition.
